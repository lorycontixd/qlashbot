...
QLASH_BRAWLSTARS_INFOBOX.set_author(name="QLASH -- Brawl Stars", url=constants.QLASH_BRAWLSTARS_DISCORD_URL, icon_url=QLASH_BRAWLSTARS_INFOBOX_ICON_URL)
...
QLASH_BRAWLSTARS_INFOBOX.add_field(name="Home page", value="[qlash.gg]({url})".format(url=constants.QLASH_BRAWLSTARS_HOMEPAGE_URL), inline=False)
QLASH_BRAWLSTARS_INFOBOX.add_field(name="Discord", value="[discord.gg/qlash-brawlstars]({url})".format(url=constants.QLASH_BRAWLSTARS_DISCORD_URL), inline=True)
QLASH_BRAWLSTARS_INFOBOX.add_field(name="Telegram", value="[t.me/QLASHBS]({url})".format(url=constants.QLASH_BRAWLSTARS_TELEGRAM_URL), inline=True)
QLASH_BRAWLSTARS_INFOBOX.add_field(name="Facebook", value="[QLASH Brawl Stars]({url})".format(url=constants.QLASH_BRAWLSTARS_FACEBOOK_URL), inline=False)
QLASH_BRAWLSTARS_INFOBOX.add_field(name="Twitter", value="[@brawlQLASH]({url})".format(url=constants.QLASH_BRAWLSTARS_TWITTER_URL), inline=True)
QLASH_BRAWLSTARS_INFOBOX.add_field(name="Instagram", value="[@qlash_brawlstars]({url})".format(url=constants.QLASH_BRAWLSTARS_INSTAGRAM_URL), inline=True)
QLASH_BRAWLSTARS_INFOBOX.add_field(name="YouTube", value="[QLASH YouTube]({url})".format(url=constants.QLASH_BRAWLSTARS_YOUTUBE_URL), inline=False)
